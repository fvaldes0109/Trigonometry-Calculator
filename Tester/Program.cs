...
// System.Console.WriteLine( Calculate.CalculateInput("(sen(1) + cos(0.01)) / tan(sen(1)) ^ p + arccsc(tan(0.4) + 5) * cot(1) - arcsen(0.3) / e - sec(0.1) * csc(-2.3) + arctan(0.1) ^ arccos(-0.05) - 1 - arccot(0.5-p/6) - arcsec(4 + 1)", 0.1) );
